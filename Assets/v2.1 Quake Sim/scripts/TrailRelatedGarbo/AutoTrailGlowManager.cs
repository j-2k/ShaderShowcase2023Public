...
public class AutoTrailGlowManager : MonoBehaviour
{
    ...
    void Start()
    {
        for (int i = 0; i < 6; i++)
        {
            smr.SetBlendShapeWeight(i + 6, AutoTrailEffect.smrIndices[i]);
        }
    ...
    void Update()
    {
        ...
        else
        {
            ...
            t += (AutoTrailEffect.fadeTimeMultiplier * Time.deltaTime);
        }
    }
}
